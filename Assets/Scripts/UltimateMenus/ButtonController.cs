...
public class ButtonController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler 
{
	...
	public void LoadWebsite(string URLToOpen) // Maybe you want your users to be able to donate?
	{
		Application.OpenURL (""); // This opens up a website specified through the string passed in with the function. 
    }
