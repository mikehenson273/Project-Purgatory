...
namespace BreadcrumbAi
{
    ...
    public class Ai : MonoBehaviour
    {
        ...
        {
            AudioSource[] SeenAudio = GameObject.Find("EnemySightAudio").GetComponents<AudioSource>();
            ...
            // Checks if following breadcrumbs is enabled and if a breadcrumb has been found
            else if (_CanFollowBreadcrumbs && this.Ai_FindBreadcrumb())
            {
                _HasWanderPos = false; // TODO: this needs to be fixed
